...
public enum Status {
    ...
    IMPORT_WORKFLOW_DEFINE_NAME_DUPLICATE(50031,
            "found multiple workflow definitions named [{0}] in project [{1}]",
            "项目[{1}]中存在多个同名工作流定义[{0}]"),
    ...
    IMPORT_WORKFLOW_DEFINE_ONLINE_NOT_ALLOWED(50072,
            "workflow definition [{0}] in project [{1}] is online, import update is not allowed",
            "项目[{1}]中的工作流定义[{0}]已上线，不允许导入更新"),
